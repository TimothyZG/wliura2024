...
res18.load_state_dict(torch.load('./models/pt-resnet18-cifar100-1.pth'))
res50.load_state_dict(torch.load('./models/pt-resnet50-cifar100-1.pth'))
res101.load_state_dict(torch.load('./models/pt-resnet101-cifar100-1.pth'))
res18.eval()
res50.eval()
res101.eval()
