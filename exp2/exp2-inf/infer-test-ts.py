...
with torch.no_grad():
    for data, targets in test_dataloader:
        ...
        # Forward pass scaled by Temperature We got for each model:
        temp18 = -11.864
        temp50 = 1.039
        temp101 = 1.2645
        outputs18 = res18(data) / temp18
        outputs50 = res50(data) / temp50
        outputs101 = res101(data) / temp101
        
        
        
        probs18 = softmax(outputs18, dim=1)
        probs50 = softmax(outputs50, dim=1)
        probs101 = softmax(outputs101, dim=1)
