...
# python recipe/rxrx1/train.py --suffix 1 --config-path "recipe/rxrx1/config-train-18.yaml" --data-path "$DATA_DIR"

# python recipe/rxrx1/train.py --suffix 0 --config-path "recipe/rxrx1/config-train-34.yaml" --data-path "$DATA_DIR"
python recipe/rxrx1/train.py --suffix 1 --config-path "recipe/rxrx1/config-train-34.yaml" --data-path "$DATA_DIR"

# python recipe/rxrx1/train.py --suffix 0 --config-path "recipe/rxrx1/config-train-50.yaml" --data-path "$DATA_DIR"
# python recipe/rxrx1/train.py --suffix 1 --config-path "recipe/rxrx1/config-train-50.yaml" --data-path "$DATA_DIR"

# python recipe/rxrx1/train.py --suffix 0 --config-path "recipe/rxrx1/config-train-101.yaml" --data-path "$DATA_DIR"
# python recipe/rxrx1/train.py --suffix 1 --config-path "recipe/rxrx1/config-train-101.yaml" --data-path "$DATA_DIR"

# python recipe/rxrx1/train.py --suffix 0 --config-path "recipe/rxrx1/config-train-152.yaml" --data-path "$DATA_DIR"
# python recipe/rxrx1/train.py --suffix 1 --config-path "recipe/rxrx1/config-train-152.yaml" --data-path "$DATA_DIR"
