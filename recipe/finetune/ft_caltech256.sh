...
# python recipe/finetune/main.py -d Caltech256 -m ViT_B_16 -pn Caltech256-ms -w 16 -e 10 -dr $SLURM_TMPDIR/data --lr 0.001  -r 384 -bs 128
# python recipe/finetune/main.py -d Caltech256 -m ViT_L_16 -pn Caltech256-ms -w 16 -e 10 -dr $SLURM_TMPDIR/data --lr 0.001  -r 512 -bs 128
# python recipe/finetune/main.py -d Caltech256 -m ViT_H_14 -pn Caltech256-ms -w 16 -e 10 -dr $SLURM_TMPDIR/data --lr 0.001  -r 510 -bs 128