...
python recipe/finetune/main.py -d CIFAR10 -m ViT_B_16 -pn CIFAR10-ms -w 16 -e 30 -dr $SLURM_TMPDIR/data --lr 0.001 -r 384
python recipe/finetune/main.py -d CIFAR10 -m ViT_L_16 -pn CIFAR10-ms -w 16 -e 30 -dr $SLURM_TMPDIR/data --lr 0.001 -r 512
python recipe/finetune/main.py -d CIFAR10 -m ViT_H_14 -pn CIFAR10-ms -w 16 -e 30 -dr $SLURM_TMPDIR/data --lr 0.001 -r 518